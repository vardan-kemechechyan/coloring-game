...
namespace BBG.MobileTools
{
	public class AdMobNetworkHandler : AdNetworkHandler
	{
		...
		protected override void DoLoadInterstitialAd()
		{
			...
			interstitialAd.OnPaidEvent		+= InterstitialAdPaidEvent; 
		...
		protected override void DoLoadRewardAd()
		{
			...
			rewardedAd.OnPaidEvent			+= RewardAdPaidEvent;
		...
		private void CreateBannerAd()
		{
			...
			bannerView.OnPaidEvent		+= BannerAdPaidEvent;
		...
		private void BannerAdPaidEvent(object sender, AdValueEventArgs args)
		{
			InvokeOnMainThread.Action((object[] obj) =>
			{
				NotifyPaidEvent(args.AdValue, BannerAdUnitId);
			});
		}
		...
		private void InterstitialAdPaidEvent( object sender, AdValueEventArgs args)
		{
			InvokeOnMainThread.Action((object[] obj) =>
			{
				NotifyPaidEvent(args.AdValue, InterstitialAdUnitId );
			});
		}
		...
		private void RewardAdPaidEvent(object sender, AdValueEventArgs args)
		{
			InvokeOnMainThread.Action((object[] obj) =>
			{
				NotifyPaidEvent(args.AdValue, RewardAdUnitId);
			});
		}
