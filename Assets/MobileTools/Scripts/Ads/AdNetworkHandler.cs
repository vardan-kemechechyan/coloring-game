...
namespace BBG.MobileTools
{
	public abstract class AdNetworkHandler
	{
		...
		public System.Action<AdValue, string> OnPaidEvent	{ get; set; }
		...
		protected void NotifyPaidEvent( AdValue args, string adUnit)
		{
			GameDebugManager.Log(LogTag, "Interstitial paid event");

			OnPaidEvent.Invoke(args, adUnit);

			//InvokeEvent(OnPaidEvent);
		}
